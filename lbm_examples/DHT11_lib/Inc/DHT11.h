...
#define DHT11_DQ_OUT_OFF  hal_gpio_set_value( PB_13, GPIO_PIN_RESET )
#define	DHT11_DQ_OUT_ON   hal_gpio_set_value( PB_13, GPIO_PIN_SET)
#define DHT11_DQ_IN       hal_gpio_get_value( PB_13 )
//#define	DHT11_DQ_OUT_OFF   	HAL_GPIO_WritePin( GPIOA , GPIO_PIN_0 , GPIO_PIN_RESET)
//#define	DHT11_DQ_OUT_ON   	HAL_GPIO_WritePin( GPIOA , GPIO_PIN_0 , GPIO_PIN_SET)
